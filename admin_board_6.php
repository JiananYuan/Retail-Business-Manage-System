...
<?php
    ...
    echo("            <caption>logs表</caption>");
    echo("            <thead>");
    echo("                <tr>");
    echo("                    <td style=\"font-weight: bold;\">logid</td>");
    echo("                    <td style=\"font-weight: bold;\">who</td>");
    echo("                    <td style=\"font-weight: bold;\">time</td>");
    echo("                    <td style=\"font-weight: bold;\">table_name</td>");
    echo("                    <td style=\"font-weight: bold;\">operation</td>");
    echo("                    <td style=\"font-weight: bold;\">key_value</td>");
    echo("                </tr>");
    echo("            </thead>");
    echo("            <tbody>");
?>
