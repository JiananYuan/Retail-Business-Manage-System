...
<?php
    ...
    echo("            <caption>purchases表</caption>");
    echo("            <thead>");
    echo("                <tr>");
    echo("                    <td style=\"font-weight: bold;\">pur</td>");
    echo("                    <td style=\"font-weight: bold;\">cid</td>");
    echo("                    <td style=\"font-weight: bold;\">eid</td>");
    echo("                    <td style=\"font-weight: bold;\">pid</td>");
    echo("                    <td style=\"font-weight: bold;\">qty</td>");
    echo("                    <td style=\"font-weight: bold;\">ptime</td>");
    echo("                    <td style=\"font-weight: bold;\">total_price</td>");
    echo("                </tr>");
    echo("            </thead>");
    echo("            <tbody>");
?>
