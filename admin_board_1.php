...
<?php
    ...
    echo("            <caption>customers表</caption>");
    echo("            <thead>");
    echo("                <tr>");
    echo("                    <td style=\"font-weight: bold;\">cid</td>");
    echo("                    <td style=\"font-weight: bold;\">cname</td>");
    echo("                    <td style=\"font-weight: bold;\">city</td>");
    echo("                    <td style=\"font-weight: bold;\">visits_made</td>");
    echo("                    <td style=\"font-weight: bold;\">last_visit_time</td>");
    echo("                </tr>");
    echo("            </thead>");
    echo("            <tbody>");
?>
...
if ($res -> num_rows > 0) {
    while ($row = $res -> fetch_assoc()) {
        ...
        echo '</td>';
        echo '<td>';
        echo $row['visits_made'];
        echo '</td>';
        echo '<td>';
        echo $row['last_visit_time'];
        echo '</td>';
        echo '</tr>';
    }
}
